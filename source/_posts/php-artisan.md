---
title: Laravel 中的 php artisan 命令
date: 2015-11-07 00:50:44
updated: 2015-11-07 01:22:53
tags: [PHP, Laravel]
---

## 前言
总是记不住这些 artisan 命令，写在博客里面，以后用到的时候就不用再到处找啦！
...
$ php artisan make:migration 迁移名：这将在 app/database/migrations 目录下生成一个名为 时间+迁移名.php 的数据迁移文件，并自动执行一次 php artisan dump-autoload 命令
